...
import mini.board.like.infra.ArticleLikeCountRepository;
import mini.board.like.infra.ArticleLikeRepository;
...
public class ArticleLikeService {
    ...
    public ArticleLikeResponse read(Long articleId, Long userId) {
        return articleLikeRepository.findByArticleIdAndUserId(articleId, userId)
                ...
                .orElseThrow(() -> new IllegalArgumentException("Like not found for articleId: " + articleId + " and userId: " + userId));
    }
